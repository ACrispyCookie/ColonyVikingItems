package net.colonymc.vikingcore;
...
import net.colonymc.vikingcore.enchants.EnchantBookListeners;
import net.colonymc.vikingcore.inventories.EnchantsListener;
import net.colonymc.vikingcore.inventories.RepairListener;
import net.colonymc.vikingcore.inventories.UpgradeListener;
import net.colonymc.vikingcore.items.ItemType;
import net.colonymc.vikingcore.items.SpecialBookCommand;
import net.colonymc.vikingcore.items.SpecialItemCommand;
import net.colonymc.vikingcore.items.hoenirshopper.HoenirsHopperBlock;
import net.colonymc.vikingcore.items.hoenirshopper.HoenirsHopperListeners;
import net.colonymc.vikingcore.items.runnables.HeimdallsSwordRunnable;
import net.colonymc.vikingcore.items.runnables.OdinsSpearRunnable;
import net.colonymc.vikingcore.npcs.NPCListener;
import net.colonymc.vikingcore.utils.UtilListeners;
import net.colonymc.vikingcore.voth.VothListeners;
	...
	private void initializeVikingCore() {
		...
		try {
			for(ItemType t : ItemType.values()) {
				Class<?> cl = Class.forName("net.colonymc.vikingcore.items." + t.encodedName + "." + t.className + "Listeners");
