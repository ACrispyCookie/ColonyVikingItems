...
import net.colonymc.colonyvikingitems.MainMessages;
...
public class SpecialItemCommand implements CommandExecutor, TabExecutor {
	...
	final String invalidDurability = ChatColor.translateAlternateColorCodes('&', " &5&l» &cPlease enter a valid durability bigger than 0!");
	final String invalidLevel = ChatColor.translateAlternateColorCodes('&', " &5&l» &cPlease enter a valid level bigger than 0!");
	final String usage = ChatColor.translateAlternateColorCodes('&', " &5&l» &fUsage: &d/vikingitem <type> [player] [amount] [durability] [level]");
