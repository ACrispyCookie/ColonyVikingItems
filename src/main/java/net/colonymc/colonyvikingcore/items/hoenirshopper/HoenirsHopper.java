package net.colonymc.colonyvikingcore.items.hoenirshopper;
...
public class HoenirsHopper extends SpecialItem {

	public HoenirsHopper(ItemStack i, Player p) {
		super(i, p);
	}
	
	public HoenirsHopper(ItemType type, int durability, int maxDurability, int level, Player p) {
