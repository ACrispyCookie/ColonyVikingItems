package net.colonymc.colonyvikingcore.items.ymirsdrill;
...
public class YmirsDrill extends SpecialItem {

	public YmirsDrill(ItemStack i, Player p) {
		super(i, p);
	}
	
	public YmirsDrill(ItemType type, int durability, int maxDurability, int level, Player p) {
