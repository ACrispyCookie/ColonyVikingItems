package net.colonymc.colonyvikingcore;
...
import net.colonymc.colonyvikingcore.enchants.EnchantBookListeners;
import net.colonymc.colonyvikingcore.inventories.EnchantsListener;
import net.colonymc.colonyvikingcore.inventories.RepairListener;
import net.colonymc.colonyvikingcore.inventories.UpgradeListener;
import net.colonymc.colonyvikingcore.items.ItemType;
import net.colonymc.colonyvikingcore.items.SpecialBookCommand;
import net.colonymc.colonyvikingcore.items.SpecialItemCommand;
import net.colonymc.colonyvikingcore.items.hoenirshopper.HoenirsHopperBlock;
import net.colonymc.colonyvikingcore.items.hoenirshopper.HoenirsHopperListeners;
import net.colonymc.colonyvikingcore.items.runnables.HeimdallsSwordRunnable;
import net.colonymc.colonyvikingcore.items.runnables.OdinsSpearRunnable;
import net.colonymc.colonyvikingcore.npcs.NPCListener;
import net.colonymc.colonyvikingcore.utils.UtilListeners;
import net.colonymc.colonyvikingcore.voth.VothListeners;
...
public class Main extends JavaPlugin {
	...
	public void onEnable() {
		...
		//setupRunnables();
		System.out.println(" » ColonyVikingCore has been enabled successfully!");
	}
	
	public void onDisable() {
		endRunnables();
		NPCListener.despawnNPCs();
		System.out.println(" » ColonyVikingCore has been disabled successfully!");
	}
	...
	private void initializeVikingCore() {
		...
		try {
			for(ItemType t : ItemType.values()) {
				Class<?> cl = Class.forName("net.colonymc.colonyvikingcore.items." + t.encodedName + "." + t.className + "Listeners");
